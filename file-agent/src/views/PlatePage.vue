  ...
  export default {
    ...
    methods: {
      ...
      uploadOneFile( fileRecord ) {
        ...
        var _UploadUrl = 'https://rest.directoutput.com.hk/api/easyrip/plate/' ;
...
<template>
  <v-content>
    <v-container>
      ...
      <v-row no-gutters align="center">
        <v-col cols=4>
          <v-checkbox v-model="chkDotGain50" class="mx-2" :label="$t('plate.dot-gain-50')" :value="chkDotGain50"
            @change="onOptionChanged($event, 'chkDotGain50')">
          </v-checkbox>
        </v-col>
        <v-col cols=4>
          <v-checkbox v-model="chkDotGain43" class="mx-2" :label="$t('plate.dot-gain-43')" :value="chkDotGain43"
            @change="onOptionChanged($event, 'chkDotGain43')">
          </v-checkbox>
        </v-col>
        <v-col cols=4>
          <v-checkbox v-model="chkDotGain40" class="mx-2" :label="$t('plate.dot-gain-40')" :value="chkDotGain40"
            @change="onOptionChanged($event, 'chkDotGain40')">
          </v-checkbox>
        </v-col>
      </v-row>
